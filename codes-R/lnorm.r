...
lnorm.infer = function(samples, useC=FALSE){
...
lnorm.lines = function(samples, params, useC=FALSE, ...){
	...
	y = dlnorm(x, meanlog=params[1], sdlog=params[2])
